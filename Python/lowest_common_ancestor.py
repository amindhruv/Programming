...
if __name__ == '__main__':
    ...
    print(lowest_common_ancestor(root, root.right.left.right, root.right.right.right))
    print(lowest_common_ancestor(root, root.left.right.left, root.left.right.right))
    print(lowest_common_ancestor(root, root.right, root.right.right.right))
